  ...
  return (
    <>
      <section id="home" className="p-4">
        ...
        <Container fluid="lg">
          <div
            className="absolute top-[25%] md:top-[25%] 2xl:top-[30%] mt-10"
            ref={heroText}
          >
            <h1 className="font-bold text-[#006cc1] header text-[3.2rem] md:text-6xl 2xl:text-7xl -ml-1 max-w-[350px] md:max-w-[665px] 2xl:max-w-[1200px] animate-hero-text">
              Elevate your space{' '}
              <span className="secondary-header text-black block mt-2 md:mt-4 2xl:pt-4 text-3xl md:text-[3.3rem] 2xl:text-[3.9rem] animate-hero-text">
                with Attention to Detail.
              </span>
            </h1>
            <p className="roboto-paragraph text-lg md:text-xl 2xl:text-2xl max-w-[320px] md:max-w-[620px] 2xl:max-w-[700px] mt-4 2xl:pt-2 animate-hero-text">
